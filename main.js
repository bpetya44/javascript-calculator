...
function showSelectedOperator(){
    ...
    for (let i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#244bd7";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#738ff5";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#738ff5";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#738ff5";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#738ff5";
    }
}
